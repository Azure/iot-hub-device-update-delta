...
//    {
//        TestUtility.DumpFolderHash(expectedFolderContent);
//        TestUtility.DumpFolderHash(actualFolderContent);
...
//        Assert.AreEqual(expectedFileData.Length, actualFileData.Length, $"{expectedFilePath} and {actualFilePath} have different lengths ({expectedFileData.Length} and {actualFileData.Length})");

//        Assert.IsTrue(expectedFileData.SequenceEqual(actualFileData), $"{expectedFilePath} and {actualFilePath} have different content.");
//    }
//}
