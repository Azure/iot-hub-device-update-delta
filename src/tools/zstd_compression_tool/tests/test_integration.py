...
import sys
sys.path.insert(0, os.path.abspath(f'{__file__}/../../sample'))
import helpers
...
class TestIntegration(unittest.TestCase):
    ...
    def create_test_archive(cls, input_archive_path, output_archive_path):
        ...
        recompression_script = helpers.get_combined_path(cls.repo_root_folder, 'src/tools/zstd_compression_tool/sample/recompress_tool.py')
    ...
    def create_production_archive(cls, input_archive_path, output_archive_path):
        ...
        sign_content_script = helpers.get_combined_path(cls.repo_root_folder, 'src/tools/zstd_compression_tool/sample/sign_tool.py')
